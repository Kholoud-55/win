...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
     ...
     <div class="container">
     <ul class="list-group">
      <li class="list-group-item list-group-item-warning" aria-current="true">اكتشف كيفية كسب الأرباح</li>
      <li class="list-group-item">تحقق من الفرص الرائعة للربح</li>
      <li class="list-group-item">ابدأ رحلتك نحو العائد المالي</li>
      <li class="list-group-item">تطلع إلى مستقبل مالي واعد</li>
      <li class="list-group-item">استفد من فرص الربح المتاحة</li>
     </ul>
